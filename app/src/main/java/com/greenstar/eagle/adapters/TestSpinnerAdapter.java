...
public class TestSpinnerAdapter extends ArrayAdapter<Questions> implements TextWatcher, SpinnerAdapter {
    private Activity mActivity;
    private List<Questions> list = new ArrayList<>();
    private List<Questions> backupList = new ArrayList<>();
    public TestSpinnerAdapter(@NonNull Activity activity, int resource, int textViewResourceId, List<Questions> list) {
