...
public class TokenRedemption
        extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener, View.OnFocusChangeListener, RadioGroup.OnCheckedChangeListener {

    AppDatabase db =null;

    TextView tvTokenId, tvSitarabajiCode, tvSitarabajiName, tvProviderCode, tvProviderName, tvSupervisorName, tvRegion, tvDistrict, tvReferralDate, tvReferredMethod;

    Button btnSubmit, btnSearchToken;

    EditText etTokenId;

    Spinner spMethodAdopted;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.token_redemption_form_activity);
    ...
    private void initializeVariables(){
        ...
        tvReferralDate = findViewById(R.id.tvReferralDate);
        tvReferredMethod = findViewById(R.id.tvReferredMethod);
        spMethodAdopted = findViewById(R.id.spAdoptedMethod);

        btnSubmit = findViewById(R.id.btnSubmit);
        btnSubmit.setOnClickListener(this);

        btnSearchToken = findViewById(R.id.btnSearchToken);
        btnSearchToken.setOnClickListener(this);
    }
