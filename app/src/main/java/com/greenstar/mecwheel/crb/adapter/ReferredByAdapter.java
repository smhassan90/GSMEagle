...
public class ReferredByAdapter extends ArrayAdapter<DropdownCRBData> {
    private Activity mActivity;
    private List<DropdownCRBData> list = new ArrayList<>();
    public ReferredByAdapter(@NonNull Activity activity, int resource, int textViewResourceId, List<DropdownCRBData> list) {
